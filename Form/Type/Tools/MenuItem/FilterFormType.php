...
class FilterFormType extends AbstractType
{
    ...
    {
        $builder                
                ->add('name',Filters\TextFilterType::class, ['label' => 'tools.menu_item.name'])                
                ->add('route',Filters\TextFilterType::class, ['label' => 'tools.menu_item.route'])                
                //->add('routeParameters',Filters\ChoiceFilterType::class)#}                
                ->add('position',Filters\NumberFilterType::class, ['label' => 'tools.menu_item.position'])                
