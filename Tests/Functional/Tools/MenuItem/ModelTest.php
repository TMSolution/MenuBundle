...
use TMSolution\MenuBundle\Model\Tools\Menu-item\Model ;
...
class SmoekTest extends CommandTestCase {
    ...
    public static  function setUpBeforeClass() {
        ...
        $generate=self::runCommand(self::$kernel, 'tmsolution:generate:fixture --bundle TMSolution\MenuBundle --dir Test --quantity 3 --silent');
    ...
    public function testUpdate() {
        ...
        $obj=$this->getEntity();
                ...
                $entity->setRoute($obj->getRoute());
                $entity->setRouteParameters($obj->getRouteParameters());
                $entity->setLft($obj->getLft());
                $entity->setLvl($obj->getLvl());
                $entity->setRgt($obj->getRgt());
                $entity->setPosition($obj->getPosition());
                $entity->setParent($obj->getParent());
                $entity->setRoot($obj->getRoot());        
